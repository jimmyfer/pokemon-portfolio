...
export async function createHouseRT01F2() {
    ...
    return new TileMapBuilder(16, 2)
        ...
        .buildSpriteObjectRow(
            [
                19556, 19556, 19556, 19556, 19556, 19556, 19556, 19556, 19556,
                19556, 19556,
            ],
            0,
            0,
        ...
        .buildSpriteObjectRow(
            [
                19572, 19572, 19572, 19572, 19572, 19572, 19572, 19572, 19572,
                19572, 19572,
            ],
            1,
            0,
        ...
        .buildSingleTriggerSprite(19533, 5, 1, false, -16, -2, bedCondition)
        .buildSingleTriggerSprite(19534, 5, 2, false, -16, -2, bedCondition)
